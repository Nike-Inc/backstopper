...
import serverconfig.classpathscan.Spring_6_1_WebMvcClasspathScanConfig;
import serverconfig.directimport.Spring_6_1_WebMvcDirectImportConfig;
 ...
 * Spring 6.1.x environment, for both classpath-scanning and direct-import Backstopper configuration use cases.
 *
 * @author Nic Munroe
 */
@SuppressWarnings({"NewClassNamingConvention", "ClassEscapesDefinedScope"})
public class BackstopperSpring_6_1_WebMvcComponentTest {
    ...
    private static final SpringMvcJettyComponentTestServer classpathScanServer = new SpringMvcJettyComponentTestServer(
        CLASSPATH_SCAN_SERVER_PORT, Spring_6_1_WebMvcClasspathScanConfig.class
    );

    private static final SpringMvcJettyComponentTestServer directImportServer = new SpringMvcJettyComponentTestServer(
        DIRECT_IMPORT_SERVER_PORT, Spring_6_1_WebMvcDirectImportConfig.class
    );
