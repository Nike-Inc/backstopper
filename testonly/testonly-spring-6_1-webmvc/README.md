# Backstopper - testonly-spring6-webmvc
...
module's functionality works as expected in Spring 6.1.x environments, for both classpath-scanning and direct-import
