...
@ComponentScan(basePackages = {
    ...
    // Component scan the controller (note this is the WebFlux controller, not the reusable servlet controller).
    "testonly.componenttest.spring.webflux.controller"
})
public class Springboot2WebFluxClasspathScanConfig {
