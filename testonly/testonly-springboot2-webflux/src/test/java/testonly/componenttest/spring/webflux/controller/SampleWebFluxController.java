package testonly.componenttest.spring.webflux.controller;
...
import static testonly.componenttest.spring.webflux.controller.SampleWebFluxController.SAMPLE_PATH;

/**
 * Contains some sample Spring WebFlux endpoints.
 *
 * <p>NOTE: This is mostly a copy of the reusable {@link
 * testonly.componenttest.spring.reusable.controller.SampleController}, except modified to use WebFlux return types
