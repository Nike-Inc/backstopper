...
import serverconfig.classpathscan.Springboot3_2WebMvcClasspathScanConfig;
import serverconfig.directimport.Springboot3_2WebMvcDirectImportConfig;
 ...
 * Spring Boot 3.2.x Web MVC environment, for both classpath-scanning and direct-import Backstopper configuration use
 * cases.
 *
 * @author Nic Munroe
 */
@SuppressWarnings({"ClassEscapesDefinedScope", "NewClassNamingConvention"})
public class BackstopperSpringboot3_2WebMvcComponentTest {
    ...
    public static void beforeClass() {
        ...
        classpathScanServerAppContext = SpringApplication.run(
            Springboot3_2WebMvcClasspathScanConfig.class, "--server.port=" + CLASSPATH_SCAN_SERVER_PORT
        );
        directImportServerAppContext = SpringApplication.run(
            Springboot3_2WebMvcDirectImportConfig.class, "--server.port=" + DIRECT_IMPORT_SERVER_PORT
        );
    }
