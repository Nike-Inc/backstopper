# Backstopper - testonly-springboot3_2-webmvc
...
Spring Boot 3.2.x Web MVC (Servlet) environments, for both classpath-scanning and direct-import Backstopper configuration 
use cases.
