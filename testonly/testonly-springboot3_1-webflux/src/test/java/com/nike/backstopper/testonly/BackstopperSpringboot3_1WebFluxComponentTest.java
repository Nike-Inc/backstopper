...
import serverconfig.classpathscan.Springboot3_1WebFluxClasspathScanConfig;
import serverconfig.directimport.Springboot3_1WebFluxDirectImportConfig;
 ...
 * Spring Boot 3.1.x WebFlux environment, for both classpath-scanning and direct-import Backstopper configuration use
 * cases.
 *
 * @author Nic Munroe
 */
@SuppressWarnings({"NewClassNamingConvention", "ClassEscapesDefinedScope"})
public class BackstopperSpringboot3_1WebFluxComponentTest {
    ...
    public static void beforeClass() {
        ...
        classpathScanServerAppContext = SpringApplication.run(
            Springboot3_1WebFluxClasspathScanConfig.class, "--server.port=" + CLASSPATH_SCAN_SERVER_PORT
        );
        directImportServerAppContext = SpringApplication.run(
            Springboot3_1WebFluxDirectImportConfig.class, "--server.port=" + DIRECT_IMPORT_SERVER_PORT
        );
    }
