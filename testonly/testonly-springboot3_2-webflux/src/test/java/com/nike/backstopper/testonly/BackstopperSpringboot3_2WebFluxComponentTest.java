...
import serverconfig.classpathscan.Springboot3_2WebFluxClasspathScanConfig;
import serverconfig.directimport.Springboot3_2WebFluxDirectImportConfig;
 ...
 * Spring Boot 3.2.x WebFlux environment, for both classpath-scanning and direct-import Backstopper configuration use
 * cases.
 *
 * @author Nic Munroe
 */
@SuppressWarnings({"NewClassNamingConvention", "ClassEscapesDefinedScope"})
public class BackstopperSpringboot3_2WebFluxComponentTest {
    ...
    public static void beforeClass() {
        ...
        classpathScanServerAppContext = SpringApplication.run(
            Springboot3_2WebFluxClasspathScanConfig.class, "--server.port=" + CLASSPATH_SCAN_SERVER_PORT
        );
        directImportServerAppContext = SpringApplication.run(
            Springboot3_2WebFluxDirectImportConfig.class, "--server.port=" + DIRECT_IMPORT_SERVER_PORT
        );
    }
