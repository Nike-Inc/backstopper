...
import serverconfig.classpathscan.Springboot3_1WebMvcClasspathScanConfig;
import serverconfig.directimport.Springboot3_1WebMvcDirectImportConfig;
 ...
 * Spring Boot 3.1.x Web MVC environment, for both classpath-scanning and direct-import Backstopper configuration use
 * cases.
 *
 * @author Nic Munroe
 */
@SuppressWarnings({"ClassEscapesDefinedScope", "NewClassNamingConvention"})
public class BackstopperSpringboot3_1WebMvcComponentTest {
    ...
    public static void beforeClass() {
        ...
        classpathScanServerAppContext = SpringApplication.run(
            Springboot3_1WebMvcClasspathScanConfig.class, "--server.port=" + CLASSPATH_SCAN_SERVER_PORT
        );
        directImportServerAppContext = SpringApplication.run(
            Springboot3_1WebMvcDirectImportConfig.class, "--server.port=" + DIRECT_IMPORT_SERVER_PORT
        );
    }
