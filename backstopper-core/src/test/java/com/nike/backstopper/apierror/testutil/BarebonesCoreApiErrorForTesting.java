...
/**
 * A barebones set of core errors that can be used for testing. See {@link ProjectApiErrorsForTesting} for a {@link ProjectApiErrors}
 * impl that uses this and is also intended for testing.
 *
 * @author Nic Munroe
 */
public enum BarebonesCoreApiErrorForTesting implements ApiError {
    ...
    NO_ACCEPTABLE_REPRESENTATION(110, "No acceptable representation for this resource", HTTP_STATUS_CODE_NOT_ACCEPTABLE),
    UNSUPPORTED_MEDIA_TYPE(120, "Unsupported media type", HTTP_STATUS_CODE_UNSUPPORTED_MEDIA_TYPE),
    TOO_MANY_REQUESTS(130, "Too many requests or simultaneous requests not allowed for this endpoint", HTTP_STATUS_CODE_TOO_MANY_REQUESTS);
