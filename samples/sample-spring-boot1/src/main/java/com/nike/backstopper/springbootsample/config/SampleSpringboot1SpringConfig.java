package com.nike.backstopper.springbootsample.config;

import com.nike.backstopper.apierror.projectspecificinfo.ProjectApiErrors;
import com.nike.backstopper.exception.ApiException;
import com.nike.backstopper.handler.springboot.config.BackstopperSpringboot1Config;
import com.nike.backstopper.handler.springboot.controller.BackstopperSpringboot1ContainerErrorController;
 ...
 *
 * <p>NOTE: This integrates Backstopper by {@link Import}ing {@link BackstopperSpringboot1Config}. Alternatively,
 ...
 */
@Configuration
@Import(BackstopperSpringboot1Config.class)
// Instead of @Import(BackstopperSpringboot1Config.class), you could component scan the com.nike.backstopper
//      package like this if you prefer component scanning: @ComponentScan(basePackages = "com.nike.backstopper")
public class SampleSpringboot1SpringConfig {
     ...
     * be used to exercise the {@link BackstopperSpringboot1ContainerErrorController}. You wouldn't want this in
     * a real app.
     */
    @Bean
