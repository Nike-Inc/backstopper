# Backstopper Sample Application - spring-boot2

Backstopper is a framework-agnostic API error handling and (optional) model validation solution for Java 7 and greater.

This submodule contains a sample application based on Spring Boot 2 that fully integrates Backstopper.
...
from the `backstopper-spring-boot2` dependency registers itself to handle these non-Spring container errors, where it 
