...
/**
 * Tests the functionality of {@link Jersey1UnhandledExceptionHandler }
 *
 * Created by dsand7 on 9/25/14.
 */
public class Jersey1UnhandledExceptionHandlerTest {

    private static Jersey1UnhandledExceptionHandler handler;
    ...
    public static void doBeforeClass() {
        handler = new Jersey1UnhandledExceptionHandler(testProjectApiErrors, ApiExceptionHandlerUtils.DEFAULT_IMPL);
    }
