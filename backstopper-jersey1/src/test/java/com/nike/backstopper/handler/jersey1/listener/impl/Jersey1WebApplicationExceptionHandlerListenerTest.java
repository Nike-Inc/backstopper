package com.nike.backstopper.handler.jersey1.listener.impl;
...
/**
 * Tests the functionality of {@link Jersey1WebApplicationExceptionHandlerListener}
 *
 * Created by dsand7 on 9/25/14.
 */
@RunWith(DataProviderRunner.class)
public class Jersey1WebApplicationExceptionHandlerListenerTest extends ListenerTestBase {

    private static Jersey1WebApplicationExceptionHandlerListener listener;
    ...
    public static void setupClass() {
        listener = new Jersey1WebApplicationExceptionHandlerListener(testProjectApiErrors, utils);
    }
    ...
    public void constructor_sets_fields_to_passed_in_args() {
        ...
        Jersey1WebApplicationExceptionHandlerListener
            impl = new Jersey1WebApplicationExceptionHandlerListener(projectErrorsMock, utilsMock);
    ...
    public void constructor_throws_IllegalArgumentException_if_passed_null_projectApiErrors() {
        ...
        Throwable ex = Assertions.catchThrowable(new ThrowableAssert.ThrowingCallable() {
            ...
            public void call() throws Throwable {
                new Jersey1WebApplicationExceptionHandlerListener(null, utils);
            }
        });
    ...
    public void constructor_throws_IllegalArgumentException_if_passed_null_utils() {
        ...
        Throwable ex = Assertions.catchThrowable(new ThrowableAssert.ThrowingCallable() {
            @Override
            public void call() throws Throwable {
                new Jersey1WebApplicationExceptionHandlerListener(testProjectApiErrors, null);
            }
        });
